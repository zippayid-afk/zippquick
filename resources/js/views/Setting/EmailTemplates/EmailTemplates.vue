<template>
    <div class="list-page">
      <div class="page-head">
        <h3 class="page-head-title">{{ __('email_templates') }}</h3>
        ...
        >
          ...
          <template #cell(actions)="row">
            <div class="list-actions">
              <button
                v-if="$can('manage_email_templates')"
  ...
  export default {
    ...
    methods: {      getTemplates() {
        ...
        axios.get(this.$apiUrl + '/email_templates/list', { params }).then((response) => {
      ...
      onTemplateSaved() {
        ...
        this.showMessage('success', this.__('email_template_updated_successfully'));
        this.getTemplates();
      },
    },
  };
