...
class Paypal{
    ...
    function __construct($gateways = null){
        ...
        $businessEmail = $g['paypal_business_email'] ?? '';
        $currency_code = $g['paypal_currency_code'] ?? '';
    ...
    function paypal_auto_form(){
        ...
        echo '<body style="text-align:center; font-size:2em;" onLoad="document.forms[\'paypal_auto_form\'].submit();">' . "<br>";
        echo '<p style="text-align:center;">Please wait, your order is being processed and you will be redirected to the paypal website.</p><br>';
